...
?>
<br><br><br><br>
<div class='col-md-12' align='center'><strong>Jara<font color='#ff3300'>zone</font></strong> Admin Log In</div><br>
...
<form role="form" action="adminlogin.php" method="POST">
 <div class='col-md-12'>
  ...
  <div class='col-md-4' style="text-align:center; "><button type="submit" class="btn btn-primary btn-sm btn-block" >Log In</button></div>
   <div class='col-md-4'></div>
 <div class='col-md-12' align='center'> <a onclick='admin_login_signup(1)' class='btn btn-success btn-sm' role='button'>Create New Account</a></div>
    </div>
	</div>
	</form>
