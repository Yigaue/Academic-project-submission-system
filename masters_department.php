...
<input type='hidden' class='form-control' id='protypeid' name='protypeid' value='<?php echo $protypeid ?>'></input>
<input type='hidden' class='form-control' id='deptt' name='deptt' value='<?php echo $department ?>'></input>
<div class='col-md-12 dark3' align='center' style='height:300px;'><h3><strong>
<br><br>
  ...
  <div class="tab-content">
    <div id="recent" class="tab-pane fade in active">
		...
		<div class='well well-md col-md-6' style='background-color: #f8f8f8; border-color: #e7e7e7;' id='recent_func'>
					   <?php
						display_type_departmental_projects($cxn,$departmentid,$protypeid);
						?>
						<div  id="show_more_main">
							<span id="show"> <button type='button' class='btn btn-primary btn-sm btn-block' onclick='show_more_type(<?php echo $projectid ?>)'>Show more</button> </span>
    ...
    <div id="free" class="tab-pane fade col-md-12">
							<strong><h4 style='text-align:center;'>Top Free <?php echo $department ?>  Projects</h4></strong>
							<div class='col-md-3' style='background-color: #f8f8f8; border-color:#f8f8f8;'></div>
		<div class='well well-md col-md-6' style='background-color: #f8f8f8; border-color: #e7e7e7;' id='free_func'>
							<?php
							display_free_type_Departmental_projects($cxn,$departmentid,$protypeid);
							 ?>
	<div  id="show_more_main_free">
        <span id="show_free"> <button type='button' class='btn btn-primary btn-sm btn-block' onclick='show_more_free_type(<?php echo $projectid ?>)'>Show more</button> </span>
    ...
    <div id="paid" class="tab-pane fade">
		...
		<div class='well well-md col-md-6' style='background-color: #f8f8f8; border-color: #e7e7e7;' id='paid_func'>
							<?php
							 display_paid_type_departmental_projects($cxn,$departmentid,$protypeid);
							 ?>
										<div  id="show_more_main_paid">
        <span id="show_paid"> <button type='button' class='btn btn-primary btn-sm btn-block' onclick='show_more_paid_type(<?php echo $projectid ?>)'>Show more</button> </span>
